...
export const ADVENTURE_THEME = ["karts", "lake", "paintball", "campground", "park", "horseback", "racing", "rafting"];
export const CULTURE_THEME = ["museum", "art", "gallery", "theatercompany", "historiclandmark", "zoo", "opera", "ballet"];
...
export const INITIAL_THEME = CULTURE_THEME;
